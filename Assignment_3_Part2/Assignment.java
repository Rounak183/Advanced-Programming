...
class GameControl
{
	...
	protected final void DisplayStartPosition(int hint)
	{
		...
		System.out.println("HINT - "+"choose("+hint+")");
		System.out.println("Enter -1 to exit");
	}
	protected final void DisplayPosition_1(int hint)
	{
	...
	protected void DisplayPosition_2(int hint)
	{
	...
	protected final void DisplayPosition_3(int hint)
	{
	...
	protected final void DisplayPosition_4(int hint)
	{
	...
	protected final void DisplayPosition_5(int hint)
	{
	...
	protected final void DisplayPosition_6(int hint)
	{
...
class Assignment
{
	public static void main(String[] args)
	{
		...
		int level_1=monsters.get(0).getLevel();
		int level_2=monsters.get(1).getLevel();
		int level_4=monsters.get(3).getLevel();
		int level_5=monsters.get(4).getLevel();
		if ((level_2+level_5)<(level_1+level_4))
		{	
			hints[0]=2;
		}
		else if ((level_2+level_5)==(level_1+level_4))
		{
			if (level_2<level_1)
				hints[0]=2;
			else
		...
		while (true)
		{
			...
			else 
			{
				...
				{	
					...
					if (just_start==true)
					{
						game_control.DisplayStartPosition(hints[0]);
					...
					else
					{
						if (chosen_option==0)
							...
							game_control.DisplayPosition_1(hints[1]);
						else if (chosen_option==2)
							game_control.DisplayPosition_2(hints[2]);
						else if (chosen_option==3)
							game_control.DisplayPosition_3(hints[3]);
						else if (chosen_option==4)
							game_control.DisplayPosition_4(hints[4]);
						else if (chosen_option==5)
							game_control.DisplayPosition_5(hints[5]);
						else if (chosen_option==6)
							game_control.DisplayPosition_6(hints[6]);
